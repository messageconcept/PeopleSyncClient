...
import com.messageconcept.peoplesyncclient.syncadapter.DavSyncAdapter;


public class Event extends Resource {
	private final static String TAG = "peoplesyncclient.Event";
	...
	public ByteArrayOutputStream toEntity() throws IOException {
		...
		ical.getProperties().add(new ProdId("-//messageconcept//PEOPLESYNCCLIENT " + Constants.APP_VERSION + "//EN"));
