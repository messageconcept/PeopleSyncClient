...
public class LocalAddressBook extends LocalCollection<Contact> {
	private final static String TAG = "peoplesyncclient.LocalAddressBook";
	
	protected AddressBookAccountSettings accountSettings;
	...
	public LocalAddressBook(Account account, ContentProviderClient providerClient, AddressBookAccountSettings accountSettings) {
