...
public class Contact extends Resource {
	private final static String TAG = "peoplesyncclient.Contact";
	
	public final static String
		PROPERTY_STARRED = "X-PEOPLESYNCCLIENT-STARRED",
	...
	public ByteArrayOutputStream toEntity() throws IOException {
		...
		vcard.setProdId("PEOPLESYNCCLIENT/" + Constants.APP_VERSION + " (ez-vcard/" + Ezvcard.VERSION + ")");
