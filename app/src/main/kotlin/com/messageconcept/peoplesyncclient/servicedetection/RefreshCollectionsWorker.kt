 ...
 * Called from UI, when user wants to refresh all collections of a service ([com.messageconcept.peoplesyncclient.ui.account.CollectionsFragment]).
 *
 * Input data:
 *
...
class RefreshCollectionsWorker @AssistedInject constructor(
    ...
    companion object {
         ...
         */
        fun enqueue(context: Context, serviceId: Long, autoSync: Boolean = false): Pair<String, Operation> {
