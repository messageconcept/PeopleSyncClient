...
interface StartupPlugin {
    ...
    /**
     * Runs synchronously during [com.messageconcept.peoplesyncclient.CoreApp.onCreate]. Use only for tasks that must be completed before
    ...
    /**
     * Runs asynchronously after [com.messageconcept.peoplesyncclient.CoreApp.onCreate]. Use for tasks that can be run in the background.
     *
