...
class DebugInfoActivity: AppCompatActivity() {
    ...
    companion object {
        ...
        /** Summary (dump of [com.messageconcept.peoplesyncclient.resource.LocalResource] properties) of local resource related to the problem (plain-text [String]) */
        ...
        /** file name (not path) of a log file inside [com.messageconcept.peoplesyncclient.log.DebugDirectory] ([String]) */
